    ...
    <>
      ...
      <section className="hero-ground grain relative overflow-hidden text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-20 pt-16">
          ...
          <p className="mt-6 max-w-lg text-[17px] leading-[1.65] text-white/75">
        ...
        {[...byCity.entries()].map(([city, rows]) => (
          <section key={city} className="border-b border-line py-10 first:pt-0 last:border-0">
            <div className="flex flex-wrap items-baseline justify-between gap-3">
              <h2 className="font-display text-[1.9rem] leading-tight tracking-[-0.025em]">
                From {cityTitle(city)}
              </h2>
              <Link
                href={cityPath(city)}
                className="group inline-flex items-center gap-1.5 text-[14px] font-semibold text-forest hover:text-accent"
              >
